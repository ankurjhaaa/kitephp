...
<body
    class="bg-[#0f111a] text-gray-300 antialiased font-sans flex flex-col md:flex-row min-h-screen selection:bg-blue-500/30 selection:text-blue-200">

    <!-- Mobile Header -->
    <div
        class="md:hidden bg-[#161b22] border-b border-gray-800 p-3 sticky top-0 z-20 flex justify-between items-center">
        ...
        <button onclick="document.getElementById('sidebar').classList.toggle('hidden')"
            class="p-1.5 bg-gray-800 rounded text-gray-400 hover:text-white">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Sidebar -->
    <aside id="sidebar"
        class="hidden md:flex flex-col w-full md:w-56 bg-[#161b22] border-r border-gray-800 h-screen sticky top-0 overflow-y-auto shrink-0 z-10">
        <div class="p-5">
            ...
            <nav class="space-y-0.5 text-sm font-medium">
                <a href="#intro"
                    class="block px-2.5 py-1.5 rounded hover:bg-gray-800 hover:text-white text-gray-400 transition-colors">Introduction</a>
                <a href="#structure"
                    class="block px-2.5 py-1.5 rounded hover:bg-gray-800 hover:text-white text-gray-400 transition-colors">Directory
                    Structure</a>
                <a href="#routing"
                    class="block px-2.5 py-1.5 rounded hover:bg-gray-800 hover:text-white text-gray-400 transition-colors">Routing</a>
                <a href="#controllers"
                    class="block px-2.5 py-1.5 rounded hover:bg-gray-800 hover:text-white text-gray-400 transition-colors">Controllers</a>
                <a href="#views"
                    class="block px-2.5 py-1.5 rounded hover:bg-gray-800 hover:text-white text-gray-400 transition-colors">Views
                    (Kite Engine)</a>
                <a href="#models"
                    class="block px-2.5 py-1.5 rounded hover:bg-gray-800 hover:text-white text-gray-400 transition-colors">Models
                    & Migrations</a>
                <a href="#querybuilder"
                    class="block px-2.5 py-1.5 rounded hover:bg-gray-800 hover:text-white text-gray-400 transition-colors">Query
                    Builder</a>
                <a href="#kitejs"
                    class="block px-2.5 py-1.5 rounded hover:bg-gray-800 hover:text-white text-gray-400 transition-colors">SPA
                    Engine</a>
                <a href="#helpers"
                    class="block px-2.5 py-1.5 rounded hover:bg-gray-800 hover:text-white text-gray-400 transition-colors">Helpers</a>
            </nav>
        </div>
    </aside>
    ...
    <main class="flex-1 overflow-x-hidden">
        <div class="max-w-4xl mx-auto p-5 md:p-8 xl:p-10">
            ...
            <div id="intro" class="mb-10 pt-2">
                <h1 class="text-3xl md:text-4xl font-extrabold tracking-tight text-white mb-3">The Full Stack PHP
                    Micro-Framework</h1>
                <p class="text-sm text-gray-400 leading-relaxed mb-5 max-w-2xl">KitePHP gives you the developer
                    experience of Laravel and the speed of a React SPA, without the heavy setup. It comes with built-in
                    TailwindCSS, smart migrations, and a zero-config SPA engine.</p>
                <div class="flex flex-wrap gap-3">
                    <a href="#models"
                        class="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white text-sm font-semibold rounded transition-colors">Explore
                        Models</a>
                    <a href="#kitejs"
                        class="px-4 py-2 bg-gray-800 border border-gray-700 hover:bg-gray-700 text-gray-300 text-sm font-semibold rounded transition-colors">Learn
                        KiteJS</a>
                    <a href="{{ route('users.index') }}" kite:navigate
                        class="px-4 py-2 bg-green-600 hover:bg-green-500 text-white text-sm font-semibold rounded shadow-lg shadow-green-900/20 transition-colors flex items-center gap-2">
            ...
            <section id="structure" class="mb-10 scroll-mt-20">
                ...
                <pre
                    class="bg-[#0d1117] border border-gray-800 rounded-lg p-4 text-xs font-mono overflow-x-auto text-gray-300 leading-normal mb-4"><code><span class="text-blue-400 font-bold">kitephp/</span>
...
└── <span class="text-green-400">kite</span>          <span class="text-gray-500"># CLI Tool</span></code></pre>
            ...
            <section id="routing" class="mb-10 scroll-mt-20">
                ...
                <p class="text-gray-400 text-sm mb-3">Routes are registered in <code
                        class="bg-gray-800 text-pink-400 px-1 py-0.5 rounded font-mono text-xs">route/url.php</code>.
                </p>
                <pre
                    class="bg-[#0d1117] border border-gray-800 rounded-lg p-4 text-xs font-mono overflow-x-auto text-gray-300 leading-normal mb-4"><code><span class="text-gray-500">// Basic GET and POST routes</span>
...
<span class="text-purple-400">get</span>(<span class="text-green-400">'/user/{id}'</span>, <span class="text-blue-400">function</span>(<span class="text-yellow-300">$id</span>) {
    <span class="text-blue-400">return</span> <span class="text-green-400">"User ID: "</span> . <span class="text-yellow-300">$id</span>;
            ...
            <section id="controllers" class="mb-10 scroll-mt-20">
                ...
                <p class="text-gray-400 text-sm mb-3">The <code
                        class="bg-gray-800 text-pink-400 px-1 py-0.5 rounded font-mono text-xs">Request</code> object is
                    automatically injected.</p>
                <pre
                    class="bg-[#0d1117] border border-gray-800 rounded-lg p-4 text-xs font-mono overflow-x-auto text-gray-300 leading-normal mb-4"><code><span class="text-blue-400">namespace</span> <span class="text-yellow-200">App\Controller</span>;
    ...
    <span class="text-blue-400">public function</span> <span class="text-purple-400">store</span>(Request <span class="text-yellow-300">$request</span>) {
        ...
        <span class="text-blue-400">return</span> <span class="text-purple-400">redirect</span>(<span class="text-purple-400">route</span>(<span class="text-green-400">'home'</span>));
            ...
            <section id="views" class="mb-10 scroll-mt-20">
                ...
                <p class="text-gray-400 text-sm mb-3">Similar to Laravel Blade. Use <code
                        class="bg-gray-800 text-pink-400 px-1 py-0.5 rounded font-mono text-xs">.kite.php</code>
                    extension.</p>
                <pre
                    class="bg-[#0d1117] border border-gray-800 rounded-lg p-4 text-xs font-mono overflow-x-auto text-gray-300 leading-normal mb-4"><code><span class="text-blue-400">&#64;extends</span>(<span class="text-green-400">'layout'</span>)
...
<span class="text-blue-400">&#64;endsection</span></code></pre>
            ...
            <section id="models" class="mb-10 scroll-mt-20">
                ...
                <p class="text-gray-400 text-sm mb-3">Define schemas in <code
                        class="bg-gray-800 text-pink-400 px-1 py-0.5 rounded font-mono text-xs">database/models.php</code>.
                    Run <code
                        class="bg-blue-900/50 text-blue-300 px-1.5 py-0.5 rounded font-mono text-xs border border-blue-800">php kite migrate</code>
                    to sync.</p>
                <pre
                    class="bg-[#0d1117] border border-gray-800 rounded-lg p-4 text-xs font-mono overflow-x-auto text-gray-300 leading-normal mb-4"><code><span class="text-blue-400">class</span> <span class="text-yellow-300">Product</span> <span class="text-blue-400">extends</span> Model {
...
<span class="text-purple-400">db</span>(<span class="text-green-400">'users'</span>)-&gt;<span class="text-purple-400">where</span>(<span class="text-green-400">'id'</span>, <span class="text-purple-400">1</span>)-&gt;<span class="text-purple-400">delete</span>();</code></pre>
            ...
            <section id="kitejs" class="mb-10 scroll-mt-20">
                ...
                <pre
                    class="bg-[#0d1117] border border-gray-800 rounded-lg p-4 text-xs font-mono overflow-x-auto text-gray-300 leading-normal mb-4"><code><span class="text-gray-500">&lt;!-- Instant Navigation --&gt;</span>
&lt;<span class="text-pink-400">a</span> <span class="text-blue-300">href</span>=<span class="text-green-400">"/about"</span> <span class="text-blue-300">kite:navigate</span>&gt;About Us&lt;/<span class="text-pink-400">a</span>&gt;

<span class="text-gray-500">&lt;!-- AJAX Form Submission --&gt;</span>
&lt;<span class="text-pink-400">form</span> <span class="text-blue-300">action</span>=<span class="text-green-400">"/login"</span> <span class="text-blue-300">method</span>=<span class="text-green-400">"POST"</span> <span class="text-blue-300">kite:submit</span>&gt;
